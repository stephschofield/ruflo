...
1. ** Decomposition**: Break complex tasks into parallelizable units
...
claude -p " auth tests" --session-id auth-tests &
...
const workers = [
  ...
  { id: "tester", task: " integration tests" },
...
| `tester` | tests | `claude -p " tests for [module]"` |
