...
handoffs:
  - agent: coordinator
    label: Collective intelligence operation completes
    prompt: collective intelligence operation completes
...
**MANDATORY: to memory IMMEDIATELY and FREQUENTLY**

```javascript
// START - initial hive status
memory_usage {
  action: "store",
...
1. collective state to `swarm/shared/collective-state`
...
### Do:
- to memory every major cognitive cycle
