...
- **Spawn Command**: `agent_spawn researcher --capabilities="research,analysis,information_gathering"`

### Code Workers 💻  
- **Capabilities**: Implementation, code review, testing, documentation
- **Use Cases**: Feature development, bug fixes, code optimization
- **Spawn Command**: `agent_spawn coder --capabilities="code_generation,testing,optimization"`

### Analyst Workers 📊
- **Capabilities**: Data analysis, performance monitoring, reporting
- **Use Cases**: Metrics analysis, performance optimization, reporting
- **Spawn Command**: `agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`

### Test Workers 🧪
- **Capabilities**: Quality assurance, validation, compliance checking
- **Use Cases**: Testing, validation, quality gates
- **Spawn Command**: `agent_spawn tester --capabilities="testing,validation,quality_assurance"`
...
const workerStatus = memory_usage {
  action: "retrieve",
...
swarm_init hierarchical --maxAgents=10 --strategy=centralized

# Spawn specialized workers
agent_spawn researcher --capabilities="research,analysis"
agent_spawn coder --capabilities="implementation,testing"  
agent_spawn analyst --capabilities="data_analysis,reporting"

# Monitor swarm health
swarm_monitor --interval=5000
```

### Orchestration
```bash
# Coordinate complex workflows
task_orchestrate "Build authentication service" --strategy=sequential --priority=high

# Load balance across workers
load_balance --tasks="auth_api,auth_tests,auth_docs" --strategy=capability_based

# Sync coordination state
coordination_sync --namespace=hierarchy
```

### Performance & Analytics
```bash
# Generate performance reports
performance_report --format=detailed --timeframe=24h

# Analyze bottlenecks
bottleneck_analyze --component=coordination --metrics="throughput,latency,success_rate"

# Monitor resource usage
metrics_collect --components="agents,tasks,coordination"
```
