 ...
 *
 * Wires AutoMemoryBridge + LearningBridge + MemoryGraph into the
 * session lifecycle. Called by hooks.json SessionStart/SessionEnd hooks.
 *
 * Usage:
...
// ============================================================================
// Read config from .ruflo/config.yaml
// ============================================================================

function readConfig() {
  const configPath = join(PROJECT_ROOT, '.ruflo', 'config.yaml');
  const defaults = {
