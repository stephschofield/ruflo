 ...
 *
 * Wires AutoMemoryBridge + LearningBridge + MemoryGraph into
 * session lifecycle. Called by hooks.json SessionStart/Stop hooks.
 *
 * Usage:
 *   node auto-memory-hook.mjs import   # SessionStart: import auto memory files into backend
 *   node auto-memory-hook.mjs sync     # Stop: sync insights back to MEMORY.md
