...
export class PluginDiscoveryService {
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      // Teammate Plugin - Multi-agent team coordination
      {
        id: '@claude-flow/teammate-plugin',
        name: '@claude-flow/teammate-plugin',
        displayName: 'Teammate Plugin',
        description: 'Multi-agent team coordination with Copilot subagent patterns. Plan approval workflows, delegation, messaging, and BMSSP-optimized topology routing. 21 MCP tools.',
        ...
        tags: ['teammate', 'multi-agent', 'swarm', 'orchestration', 'bmssp', 'subagent'],
        keywords: ['teammate', 'multi-agent', 'subagent'],
        downloads: 0,
        rating: 0,
        ratingCount: 0,
        lastUpdated: baseTime,
